...
- ⬜ [[doc/iterations/0100-EPIC-scaffolding]] — project skeleton, ADRs, terminal backend (in progress: scaffolding built, ADRs drafted)
...
- ⬜ [[doc/iterations/0101-spike-asm-architecture]] — map the ASM design (mostly captured)
